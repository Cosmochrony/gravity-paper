\section{Introduction}
  ...
  whether it may arise as an effective response of a more primitive operator-based structure.
  ...
  In a previous analysis, we investigated a minimal mechanism by which a Newtonian interaction can emerge from the
  ...
  \paragraph{Central claim (renormalized IR locality).}
    ...
    curvature invariants satisfy \(R\,\ell_\chi^2\ll 1\), the infrared-dominant \emph{local} two-derivative part of the
    ...
    the
    infrared by additional powers of \(\ell_\chi^2\)
        , while the conformal anomaly remains as a distinct ultraviolet-sensitive
        ...
        state the dominance criterion \(R\,\ell_\chi^2\ll 1\).
