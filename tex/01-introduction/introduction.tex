...
infrared by additional powers of \(\ell_\chi^2\), while the conformal anomaly remains as a distinct ultraviolet-sensitive
...
In Section~\ref{sec:ir-hierarchy}, we formulate the infrared hierarchy as a covariant derivative expansion and state the
dominance criterion \(R\,\ell_\chi^2\ll 1\).
