\section{Introduction}
  ...
  \paragraph{Central claim (renormalized IR locality).}
    ...
    curvature invariants satisfy \(R\,\ell_{\mathrm{sp}}^2\ll 1\), the infrared-dominant \emph{local} two-derivative part of the
    ...
    infrared by additional powers of \(\ell_{\mathrm{sp}}^2\), while the conformal anomaly remains as a distinct ultraviolet-sensitive
