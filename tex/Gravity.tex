...
\begin{document}
  ...
  \subsection{Origin of the Einstein tensor}
    ...
    construction~\cite{Sakharov1967}, with the spectral resolution scale playing the role of an explicit ultraviolet
    regulator, but with the finite normalization and sign left to the full field content and matching condition.
