...
\title{Newtonian Potentials from Projective Entropy in Three Dimensions}
...
\keywords{Newtonian potential, Elliptic operators, Functional determinant, Resolvent trace, Green function, Projective entropy}
