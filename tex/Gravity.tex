...
\begin{document}
  ...
  \subsection{Setup and admissibility conditions}
    ...
    endomorphism~$X$, and the density is written in the
    Lorentzian continuation convention of
    Section~\ref{sec:discussion}, the algebra being
  ...
  \subsection{Structural interpretation}
    ...
    \begin{remark}
      ...
      it is a classification result given the
