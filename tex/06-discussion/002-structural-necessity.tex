\subsection{Structural necessity of non-injective projection}
  ...
  \begin{remark}[Heisenberg torsion as the structural source]
    ...
    for $q \in \{29, 61\}$ and all conjugate pairs $(c, q-c)$ yields
    $a_q(s) \cdot q^2 = 2.000$ uniformly across primes, pairs, and generators
    $s \in \{X^{\pm 1}, Y^{\pm 1}\}$, confirming Hypothesis~H-w
    of~\cite{Beau2026Q5a} numerically.
    The isotropy $a_q(X) = a_q(Y)$ further implies that the Dirichlet form limit
