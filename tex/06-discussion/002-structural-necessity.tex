\subsection{Structural necessity of non-injective projection}
  ...
  \begin{remark}[Heisenberg torsion as the structural source]
    ...
    for $q \in \{29, 61, 101\}$ and all conjugate pairs yields
    $a_q(s) \cdot q^2 \in \{2.002, 1.988, 1.982\}$ (means over valid pairs),
    with inter-pair standard deviations below $0.07$ and isotropy
    $|a_q(X) - a_q(Y)| \cdot q^2 < 0.05$ for the generic pairs.
    A small number of non-generic pairs (at most $2\%$ of the sample)
    exhibit larger anisotropy, consistent with special arithmetic properties
    of those characters modulo $q$.
    Hypothesis~H-w of~\cite{Beau2026Q5a} is thereby confirmed numerically:
    $a_q(s) \cdot q^2 \to 2$ as $q \to \infty$, with $A$ independent of $s$.
    The isotropy implies that the Dirichlet form limit is isotropic,
    consistent with the emergence of a Lorentzian metric.
