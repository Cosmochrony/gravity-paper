\subsection{Structural necessity of non-injective projection}
  ...
  Consider an effective physical description obtained through a projection
  \[
    \Pi : \Omega \rightarrow O ,
  \]
  mapping an underlying configuration space $\Omega$ to a space of observable
  states $O$.
  Such projections need not be injective: several distinct configurations may
  correspond to the same effective description.
