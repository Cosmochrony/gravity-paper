\subsection{Structural necessity of non-injective projection}
  ...
  \begin{remark}[Heisenberg torsion as the structural source]
    ...
    for all conjugate pairs $(c,q-c)$ at $q \in \{29, 61, 101, 151\}$
    (162 valid pairs in total) yields the cross-$q$ summary
    \[
      a_q(s)\cdot q^2 \;\in\; \{2.002,\; 1.988,\; 1.982,\; 1.972\},
    \]
    ...
    has special arithmetic properties modulo $q$, such as quadratic
    residue structure) exhibit larger anisotropy and account for
    the residual variance; generic pairs satisfy $A_{\mathrm{hw}}\approx 2.000$
    to three significant figures.
    Hypothesis~H-w of~\cite{Beau2026Q5a} is thereby confirmed numerically
    across four primes: $a_q(s)\cdot q^2 \to 2$ as $q\to\infty$,
